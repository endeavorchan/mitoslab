...
f010006d:	e8 b6 08 00 00       	call   f0100928 <vcprintf>
	cprintf("\n");
f0100072:	c7 04 24 fa 17 10 f0 	movl   $0xf01017fa,(%esp)
...
f01000be:	e8 65 08 00 00       	call   f0100928 <vcprintf>
	cprintf("\n");
f01000c3:	c7 04 24 fa 17 10 f0 	movl   $0xf01017fa,(%esp)
...
f01003ba:	c7 04 24 d3 17 10 f0 	movl   $0xf01017d3,(%esp)
...
f010040f:	0f b6 80 00 18 10 f0 	movzbl -0xfefe800(%eax),%eax
...
f010044a:	0f b6 90 00 18 10 f0 	movzbl -0xfefe800(%eax),%edx
f0100451:	0b 15 40 f3 10 f0    	or     0xf010f340,%edx
f0100457:	0f b6 88 00 19 10 f0 	movzbl -0xfefe700(%eax),%ecx
...
f010046b:	8b 0c 8d 00 1a 10 f0 	mov    -0xfefe600(,%ecx,4),%ecx
...
f01004a2:	75 17                	jne    f01004bb <kbd_proc_data+0xf3>
		cprintf("Rebooting!\n");
f01004a4:	c7 04 24 f0 17 10 f0 	movl   $0xf01017f0,(%esp)
...
f01005ee:	e8 c8 0c 00 00       	call   f01012bb <memcpy>
...
f01006e8:	c7 04 24 10 1a 10 f0 	movl   $0xf0101a10,(%esp)
...
f0100703:	f0 
f0100704:	c7 04 24 9c 1a 10 f0 	movl   $0xf0101a9c,(%esp)
f010070b:	e8 4b 02 00 00       	call   f010095b <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f0100710:	c7 44 24 08 15 17 10 	movl   $0x101715,0x8(%esp)
f0100717:	00 
f0100718:	c7 44 24 04 15 17 10 	movl   $0xf0101715,0x4(%esp)
f010071f:	f0 
f0100720:	c7 04 24 c0 1a 10 f0 	movl   $0xf0101ac0,(%esp)
...
f010073b:	f0 
f010073c:	c7 04 24 e4 1a 10 f0 	movl   $0xf0101ae4,(%esp)
...
f0100757:	f0 
f0100758:	c7 04 24 08 1b 10 f0 	movl   $0xf0101b08,(%esp)
...
f0100780:	c7 04 24 2c 1b 10 f0 	movl   $0xf0101b2c,(%esp)
...
f0100799:	a1 d0 1b 10 f0       	mov    0xf0101bd0,%eax
f010079e:	89 44 24 08          	mov    %eax,0x8(%esp)
f01007a2:	a1 cc 1b 10 f0       	mov    0xf0101bcc,%eax
f01007a7:	89 44 24 04          	mov    %eax,0x4(%esp)
f01007ab:	c7 04 24 29 1a 10 f0 	movl   $0xf0101a29,(%esp)
f01007b2:	e8 a4 01 00 00       	call   f010095b <cprintf>
f01007b7:	a1 dc 1b 10 f0       	mov    0xf0101bdc,%eax
f01007bc:	89 44 24 08          	mov    %eax,0x8(%esp)
f01007c0:	a1 d8 1b 10 f0       	mov    0xf0101bd8,%eax
f01007c5:	89 44 24 04          	mov    %eax,0x4(%esp)
f01007c9:	c7 04 24 29 1a 10 f0 	movl   $0xf0101a29,(%esp)
...
f01007e5:	c7 04 24 58 1b 10 f0 	movl   $0xf0101b58,(%esp)
f01007ec:	e8 6a 01 00 00       	call   f010095b <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01007f1:	c7 04 24 7c 1b 10 f0 	movl   $0xf0101b7c,(%esp)
...
f01007fd:	bf cc 1b 10 f0       	mov    $0xf0101bcc,%edi
	cprintf("Welcome to the JOS kernel monitor!\n");
	cprintf("Type 'help' for a list of commands.\n");
	...
	while (1) {
		buf = readline("K> ");
f0100802:	c7 04 24 32 1a 10 f0 	movl   $0xf0101a32,(%esp)
f0100809:	e8 12 08 00 00       	call   f0101020 <readline>
...
f0100836:	c7 04 24 36 1a 10 f0 	movl   $0xf0101a36,(%esp)
f010083d:	e8 fc 09 00 00       	call   f010123e <strchr>
...
f0100859:	00 
f010085a:	c7 04 24 3b 1a 10 f0 	movl   $0xf0101a3b,(%esp)
...
f0100889:	c7 04 24 36 1a 10 f0 	movl   $0xf0101a36,(%esp)
f0100890:	e8 a9 09 00 00       	call   f010123e <strchr>
...
f01008f6:	ff 92 d4 1b 10 f0    	call   *-0xfefe42c(%edx)
...
f010090c:	c7 04 24 58 1a 10 f0 	movl   $0xf0101a58,(%esp)
...
f01009a8:	0f b7 84 00 7c 1d 10 	movzwl -0xfefe284(%eax,%eax,1),%eax
f01009af:	f0 
...
f01009bd:	0f b7 84 00 bc 1d 10 	movzwl -0xfefe244(%eax,%eax,1),%eax
f01009c4:	f0 
...
f0100a4b:	e8 60 0a 00 00       	call   f01014b0 <__udivdi3>
...
f0100aa6:	e8 35 0b 00 00       	call   f01015e0 <__umoddi3>
f0100aab:	89 74 24 04          	mov    %esi,0x4(%esp)
f0100aaf:	0f be 80 e4 1b 10 f0 	movsbl -0xfefe41c(%eax),%eax
...
f0100b2a:	66 c7 45 d2 00 00    	movw   $0x0,-0x2e(%ebp)
		case '#':
			altflag = 1;
			goto reswitch;
		...
		process_precision:
			if (width < 0)
f0100b30:	c7 45 c8 ff ff ff ff 	movl   $0xffffffff,-0x38(%ebp)
f0100b37:	eb 71                	jmp    f0100baa <vprintfmt+0x8c>
        int c_flag;
        uint16_t color = 0;
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
			if (ch == '\0')
f0100b39:	85 f6                	test   %esi,%esi
f0100b3b:	0f 84 2f 04 00 00    	je     f0100f70 <vprintfmt+0x452>
				return;
		        c_flag = 1;  
            		if (ch == '$') //foreground color  
f0100b41:	b8 01 00 00 00       	mov    $0x1,%eax
f0100b46:	83 fe 24             	cmp    $0x24,%esi
f0100b49:	75 2a                	jne    f0100b75 <vprintfmt+0x57>
            		{  
                		ch = *(unsigned char *)fmt++;  
f0100b4b:	0f b6 33             	movzbl (%ebx),%esi
f0100b4e:	83 c3 01             	add    $0x1,%ebx
                		color |= get_color(1, ch);
f0100b51:	89 f2                	mov    %esi,%edx
f0100b53:	0f be c2             	movsbl %dl,%eax
f0100b56:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100b5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
f0100b61:	e8 2a fe ff ff       	call   f0100990 <get_color>
f0100b66:	66 09 45 d2          	or     %ax,-0x2e(%ebp)
                                ch |= color;  
f0100b6a:	0f b7 45 d2          	movzwl -0x2e(%ebp),%eax
f0100b6e:	09 c6                	or     %eax,%esi
f0100b70:	b8 00 00 00 00       	mov    $0x0,%eax
                		c_flag = 0;  
            		}  
            		if (ch == '#') //background color  
f0100b75:	83 fe 23             	cmp    $0x23,%esi
f0100b78:	75 1f                	jne    f0100b99 <vprintfmt+0x7b>
            {  
                ch = *(unsigned char *)fmt++;  
f0100b7a:	0f b6 03             	movzbl (%ebx),%eax
f0100b7d:	83 c3 01             	add    $0x1,%ebx
                color |= get_color(0, ch);  
f0100b80:	0f be c0             	movsbl %al,%eax
f0100b83:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100b87:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
f0100b8e:	e8 fd fd ff ff       	call   f0100990 <get_color>
f0100b93:	66 09 45 d2          	or     %ax,-0x2e(%ebp)
f0100b97:	eb 11                	jmp    f0100baa <vprintfmt+0x8c>
                c_flag = 0;  
            }  
            if (c_flag)  
f0100b99:	85 c0                	test   %eax,%eax
f0100b9b:	74 0d                	je     f0100baa <vprintfmt+0x8c>
                putch(ch, putdat);  
f0100b9d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0100ba0:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0100ba4:	89 34 24             	mov    %esi,(%esp)
f0100ba7:	ff 55 08             	call   *0x8(%ebp)
	char padc;
        int c_flag;
        uint16_t color = 0;
	...
	while (1) {
		while ((ch = *(unsigned char *) fmt++) != '%') {
f0100baa:	0f b6 33             	movzbl (%ebx),%esi
f0100bad:	83 c3 01             	add    $0x1,%ebx
f0100bb0:	83 fe 25             	cmp    $0x25,%esi
f0100bb3:	75 84                	jne    f0100b39 <vprintfmt+0x1b>
f0100bb5:	c6 45 d4 20          	movb   $0x20,-0x2c(%ebp)
f0100bb9:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%ebp)
f0100bc0:	bf ff ff ff ff       	mov    $0xffffffff,%edi
f0100bc5:	be ff ff ff ff       	mov    $0xffffffff,%esi
f0100bca:	b9 00 00 00 00       	mov    $0x0,%ecx
f0100bcf:	eb 06                	jmp    f0100bd7 <vprintfmt+0xb9>
f0100bd1:	c6 45 d4 2d          	movb   $0x2d,-0x2c(%ebp)
f0100bd5:	89 c3                	mov    %eax,%ebx
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
...
f0100bd7:	0f b6 13             	movzbl (%ebx),%edx
f0100bda:	0f b6 c2             	movzbl %dl,%eax
f0100bdd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f0100be0:	8d 43 01             	lea    0x1(%ebx),%eax
f0100be3:	83 ea 23             	sub    $0x23,%edx
f0100be6:	80 fa 55             	cmp    $0x55,%dl
f0100be9:	0f 87 60 03 00 00    	ja     f0100f4f <vprintfmt+0x431>
f0100bef:	0f b6 d2             	movzbl %dl,%edx
f0100bf2:	ff 24 95 80 1c 10 f0 	jmp    *-0xfefe380(,%edx,4)
f0100bf9:	c6 45 d4 30          	movb   $0x30,-0x2c(%ebp)
f0100bfd:	eb d6                	jmp    f0100bd5 <vprintfmt+0xb7>
		case '6':
		case '7':
		case '8':
		case '9':
...
f0100c02:	83 ef 30             	sub    $0x30,%edi
				ch = *fmt;
f0100c05:	0f be 10             	movsbl (%eax),%edx
				if (ch < '0' || ch > '9')
f0100c08:	8d 5a d0             	lea    -0x30(%edx),%ebx
f0100c0b:	83 fb 09             	cmp    $0x9,%ebx
f0100c0e:	77 39                	ja     f0100c49 <vprintfmt+0x12b>
		case '5':
		case '6':
		case '7':
		case '8':
		case '9':
			for (precision = 0; ; ++fmt) {
f0100c10:	83 c0 01             	add    $0x1,%eax
				precision = precision * 10 + ch - '0';
f0100c13:	8d 1c bf             	lea    (%edi,%edi,4),%ebx
f0100c16:	8d 7c 5a d0          	lea    -0x30(%edx,%ebx,2),%edi
				ch = *fmt;
f0100c1a:	0f be 10             	movsbl (%eax),%edx
				if (ch < '0' || ch > '9')
f0100c1d:	8d 5a d0             	lea    -0x30(%edx),%ebx
f0100c20:	83 fb 09             	cmp    $0x9,%ebx
f0100c23:	76 eb                	jbe    f0100c10 <vprintfmt+0xf2>
f0100c25:	eb 22                	jmp    f0100c49 <vprintfmt+0x12b>
					break;
			}
...
f0100c27:	8b 55 14             	mov    0x14(%ebp),%edx
f0100c2a:	83 c2 04             	add    $0x4,%edx
f0100c2d:	89 55 14             	mov    %edx,0x14(%ebp)
f0100c30:	8b 7a fc             	mov    -0x4(%edx),%edi
			goto process_precision;
f0100c33:	eb 14                	jmp    f0100c49 <vprintfmt+0x12b>

		case '.':
			if (width < 0)
f0100c35:	89 f2                	mov    %esi,%edx
f0100c37:	c1 fa 1f             	sar    $0x1f,%edx
f0100c3a:	f7 d2                	not    %edx
f0100c3c:	21 d6                	and    %edx,%esi
f0100c3e:	eb 95                	jmp    f0100bd5 <vprintfmt+0xb7>
f0100c40:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
				width = 0;
			goto reswitch;
		...
		case '#':
			altflag = 1;
			goto reswitch;
f0100c47:	eb 8c                	jmp    f0100bd5 <vprintfmt+0xb7>

		process_precision:
			if (width < 0)
f0100c49:	85 f6                	test   %esi,%esi
f0100c4b:	79 88                	jns    f0100bd5 <vprintfmt+0xb7>
f0100c4d:	89 fe                	mov    %edi,%esi
f0100c4f:	8b 7d c8             	mov    -0x38(%ebp),%edi
f0100c52:	eb 81                	jmp    f0100bd5 <vprintfmt+0xb7>
		...
		case 'l':
			lflag++;
f0100c54:	83 c1 01             	add    $0x1,%ecx
			goto reswitch;
f0100c57:	e9 79 ff ff ff       	jmp    f0100bd5 <vprintfmt+0xb7>
f0100c5c:	89 45 e4             	mov    %eax,-0x1c(%ebp)

		// character
		case 'c':
			putch(va_arg(ap, int), putdat);
f0100c5f:	8b 45 14             	mov    0x14(%ebp),%eax
f0100c62:	83 c0 04             	add    $0x4,%eax
f0100c65:	89 45 14             	mov    %eax,0x14(%ebp)
f0100c68:	8b 55 0c             	mov    0xc(%ebp),%edx
f0100c6b:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100c6f:	8b 40 fc             	mov    -0x4(%eax),%eax
f0100c72:	89 04 24             	mov    %eax,(%esp)
f0100c75:	ff 55 08             	call   *0x8(%ebp)
f0100c78:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
			break;
f0100c7b:	e9 2a ff ff ff       	jmp    f0100baa <vprintfmt+0x8c>
f0100c80:	89 45 e4             	mov    %eax,-0x1c(%ebp)

		// error message
		case 'e':
			err = va_arg(ap, int);
f0100c83:	8b 45 14             	mov    0x14(%ebp),%eax
f0100c86:	83 c0 04             	add    $0x4,%eax
f0100c89:	89 45 14             	mov    %eax,0x14(%ebp)
f0100c8c:	8b 40 fc             	mov    -0x4(%eax),%eax
f0100c8f:	89 c2                	mov    %eax,%edx
f0100c91:	c1 fa 1f             	sar    $0x1f,%edx
f0100c94:	31 d0                	xor    %edx,%eax
f0100c96:	29 d0                	sub    %edx,%eax
			if (err < 0)
				err = -err;
			if (err > MAXERROR || (p = error_string[err]) == NULL)
f0100c98:	83 f8 06             	cmp    $0x6,%eax
f0100c9b:	7f 0b                	jg     f0100ca8 <vprintfmt+0x18a>
f0100c9d:	8b 14 85 d8 1d 10 f0 	mov    -0xfefe228(,%eax,4),%edx
f0100ca4:	85 d2                	test   %edx,%edx
f0100ca6:	75 26                	jne    f0100cce <vprintfmt+0x1b0>
				printfmt(putch, putdat, "error %d", err);
f0100ca8:	89 44 24 0c          	mov    %eax,0xc(%esp)
f0100cac:	c7 44 24 08 f5 1b 10 	movl   $0xf0101bf5,0x8(%esp)
f0100cb3:	f0 
f0100cb4:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0100cb7:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0100cbb:	8b 45 08             	mov    0x8(%ebp),%eax
f0100cbe:	89 04 24             	mov    %eax,(%esp)
f0100cc1:	e8 32 03 00 00       	call   f0100ff8 <printfmt>
f0100cc6:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
		...
		case 'e':
			...
			if (err < 0)
				err = -err;
			if (err > MAXERROR || (p = error_string[err]) == NULL)
f0100cc9:	e9 dc fe ff ff       	jmp    f0100baa <vprintfmt+0x8c>
				printfmt(putch, putdat, "error %d", err);
			else
				printfmt(putch, putdat, "%s", p);
f0100cce:	89 54 24 0c          	mov    %edx,0xc(%esp)
f0100cd2:	c7 44 24 08 fe 1b 10 	movl   $0xf0101bfe,0x8(%esp)
f0100cd9:	f0 
f0100cda:	8b 55 0c             	mov    0xc(%ebp),%edx
f0100cdd:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100ce1:	8b 4d 08             	mov    0x8(%ebp),%ecx
f0100ce4:	89 0c 24             	mov    %ecx,(%esp)
f0100ce7:	e8 0c 03 00 00       	call   f0100ff8 <printfmt>
f0100cec:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
f0100cef:	e9 b6 fe ff ff       	jmp    f0100baa <vprintfmt+0x8c>
f0100cf4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
f0100cf7:	89 c3                	mov    %eax,%ebx
f0100cf9:	89 fa                	mov    %edi,%edx
f0100cfb:	89 75 c4             	mov    %esi,-0x3c(%ebp)
			break;
...
f0100d01:	83 c0 04             	add    $0x4,%eax
f0100d04:	89 45 14             	mov    %eax,0x14(%ebp)
f0100d07:	8b 40 fc             	mov    -0x4(%eax),%eax
f0100d0a:	89 45 cc             	mov    %eax,-0x34(%ebp)
f0100d0d:	85 c0                	test   %eax,%eax
f0100d0f:	75 07                	jne    f0100d18 <vprintfmt+0x1fa>
f0100d11:	c7 45 cc 01 1c 10 f0 	movl   $0xf0101c01,-0x34(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
f0100d18:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
f0100d1c:	7e 06                	jle    f0100d24 <vprintfmt+0x206>
f0100d1e:	80 7d d4 2d          	cmpb   $0x2d,-0x2c(%ebp)
f0100d22:	75 13                	jne    f0100d37 <vprintfmt+0x219>
				for (width -= strnlen(p, precision); width > 0; width--)
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
f0100d24:	8b 55 cc             	mov    -0x34(%ebp),%edx
f0100d27:	0f be 02             	movsbl (%edx),%eax
f0100d2a:	85 c0                	test   %eax,%eax
f0100d2c:	0f 85 96 00 00 00    	jne    f0100dc8 <vprintfmt+0x2aa>
f0100d32:	e9 85 00 00 00       	jmp    f0100dbc <vprintfmt+0x29e>
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f0100d37:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100d3b:	8b 4d cc             	mov    -0x34(%ebp),%ecx
f0100d3e:	89 0c 24             	mov    %ecx,(%esp)
f0100d41:	e8 c5 03 00 00       	call   f010110b <strnlen>
f0100d46:	8b 75 c4             	mov    -0x3c(%ebp),%esi
f0100d49:	29 c6                	sub    %eax,%esi
f0100d4b:	85 f6                	test   %esi,%esi
f0100d4d:	7e d5                	jle    f0100d24 <vprintfmt+0x206>
					putch(padc, putdat);
f0100d4f:	0f be 45 d4          	movsbl -0x2c(%ebp),%eax
f0100d53:	89 7d c4             	mov    %edi,-0x3c(%ebp)
f0100d56:	8b 7d 0c             	mov    0xc(%ebp),%edi
f0100d59:	89 5d c0             	mov    %ebx,-0x40(%ebp)
f0100d5c:	89 c3                	mov    %eax,%ebx
f0100d5e:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0100d62:	89 1c 24             	mov    %ebx,(%esp)
f0100d65:	ff 55 08             	call   *0x8(%ebp)
		// string
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
f0100d68:	83 ee 01             	sub    $0x1,%esi
f0100d6b:	85 f6                	test   %esi,%esi
f0100d6d:	7f ef                	jg     f0100d5e <vprintfmt+0x240>
f0100d6f:	8b 7d c4             	mov    -0x3c(%ebp),%edi
f0100d72:	8b 5d c0             	mov    -0x40(%ebp),%ebx
f0100d75:	be 00 00 00 00       	mov    $0x0,%esi
f0100d7a:	eb a8                	jmp    f0100d24 <vprintfmt+0x206>
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
f0100d7c:	83 7d d8 00          	cmpl   $0x0,-0x28(%ebp)
f0100d80:	74 1b                	je     f0100d9d <vprintfmt+0x27f>
f0100d82:	8d 50 e0             	lea    -0x20(%eax),%edx
f0100d85:	83 fa 5e             	cmp    $0x5e,%edx
f0100d88:	76 13                	jbe    f0100d9d <vprintfmt+0x27f>
					putch('?', putdat);
f0100d8a:	8b 55 0c             	mov    0xc(%ebp),%edx
f0100d8d:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100d91:	c7 04 24 3f 00 00 00 	movl   $0x3f,(%esp)
f0100d98:	ff 55 08             	call   *0x8(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
f0100d9b:	eb 0d                	jmp    f0100daa <vprintfmt+0x28c>
					putch('?', putdat);
				else
					putch(ch, putdat);
f0100d9d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0100da0:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0100da4:	89 04 24             	mov    %eax,(%esp)
f0100da7:	ff 55 08             	call   *0x8(%ebp)
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
...
f0100dad:	0f be 03             	movsbl (%ebx),%eax
f0100db0:	85 c0                	test   %eax,%eax
f0100db2:	74 05                	je     f0100db9 <vprintfmt+0x29b>
f0100db4:	83 c3 01             	add    $0x1,%ebx
f0100db7:	eb 1a                	jmp    f0100dd3 <vprintfmt+0x2b5>
f0100db9:	8b 5d cc             	mov    -0x34(%ebp),%ebx
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
			for (; width > 0; width--)
f0100dbc:	85 f6                	test   %esi,%esi
f0100dbe:	7f 21                	jg     f0100de1 <vprintfmt+0x2c3>
f0100dc0:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
f0100dc3:	e9 e2 fd ff ff       	jmp    f0100baa <vprintfmt+0x8c>
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
			if (width > 0 && padc != '-')
				for (width -= strnlen(p, precision); width > 0; width--)
					putch(padc, putdat);
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
f0100dc8:	8b 55 cc             	mov    -0x34(%ebp),%edx
f0100dcb:	83 c2 01             	add    $0x1,%edx
f0100dce:	89 5d cc             	mov    %ebx,-0x34(%ebp)
f0100dd1:	89 d3                	mov    %edx,%ebx
f0100dd3:	85 ff                	test   %edi,%edi
f0100dd5:	78 a5                	js     f0100d7c <vprintfmt+0x25e>
f0100dd7:	83 ef 01             	sub    $0x1,%edi
f0100dda:	79 a0                	jns    f0100d7c <vprintfmt+0x25e>
f0100ddc:	8b 5d cc             	mov    -0x34(%ebp),%ebx
f0100ddf:	eb db                	jmp    f0100dbc <vprintfmt+0x29e>
f0100de1:	8b 7d 08             	mov    0x8(%ebp),%edi
f0100de4:	89 5d d8             	mov    %ebx,-0x28(%ebp)
f0100de7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
			...
			for (; width > 0; width--)
				putch(' ', putdat);
f0100dea:	89 5c 24 04          	mov    %ebx,0x4(%esp)
f0100dee:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
f0100df5:	ff d7                	call   *%edi
			for (; (ch = *p++) != '\0' && (precision < 0 || --precision >= 0); width--)
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
			for (; width > 0; width--)
f0100df7:	83 ee 01             	sub    $0x1,%esi
f0100dfa:	85 f6                	test   %esi,%esi
f0100dfc:	7f ec                	jg     f0100dea <vprintfmt+0x2cc>
f0100dfe:	8b 5d d8             	mov    -0x28(%ebp),%ebx
f0100e01:	e9 a4 fd ff ff       	jmp    f0100baa <vprintfmt+0x8c>
...
{
	if (lflag >= 2)
f0100e09:	83 f9 01             	cmp    $0x1,%ecx
f0100e0c:	7e 17                	jle    f0100e25 <vprintfmt+0x307>
		return va_arg(*ap, long long);
f0100e0e:	8b 45 14             	mov    0x14(%ebp),%eax
f0100e11:	83 c0 08             	add    $0x8,%eax
f0100e14:	89 45 14             	mov    %eax,0x14(%ebp)
f0100e17:	8b 50 f8             	mov    -0x8(%eax),%edx
f0100e1a:	8b 48 fc             	mov    -0x4(%eax),%ecx
f0100e1d:	89 55 d8             	mov    %edx,-0x28(%ebp)
f0100e20:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f0100e23:	eb 34                	jmp    f0100e59 <vprintfmt+0x33b>
	else if (lflag)
f0100e25:	85 c9                	test   %ecx,%ecx
f0100e27:	74 19                	je     f0100e42 <vprintfmt+0x324>
		return va_arg(*ap, long);
f0100e29:	8b 45 14             	mov    0x14(%ebp),%eax
f0100e2c:	83 c0 04             	add    $0x4,%eax
f0100e2f:	89 45 14             	mov    %eax,0x14(%ebp)
f0100e32:	8b 40 fc             	mov    -0x4(%eax),%eax
f0100e35:	89 45 d8             	mov    %eax,-0x28(%ebp)
f0100e38:	89 c1                	mov    %eax,%ecx
f0100e3a:	c1 f9 1f             	sar    $0x1f,%ecx
f0100e3d:	89 4d dc             	mov    %ecx,-0x24(%ebp)
f0100e40:	eb 17                	jmp    f0100e59 <vprintfmt+0x33b>
	else
...
f0100e51:	89 c2                	mov    %eax,%edx
f0100e53:	c1 fa 1f             	sar    $0x1f,%edx
f0100e56:	89 55 dc             	mov    %edx,-0x24(%ebp)
				putch(' ', putdat);
			break;
		...
		case 'd':
			num = getint(&ap, lflag);
f0100e59:	8b 45 d8             	mov    -0x28(%ebp),%eax
f0100e5c:	8b 55 dc             	mov    -0x24(%ebp),%edx
f0100e5f:	b9 0a 00 00 00       	mov    $0xa,%ecx
			if ((long long) num < 0) {
f0100e64:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
f0100e68:	0f 89 9c 00 00 00    	jns    f0100f0a <vprintfmt+0x3ec>
				putch('-', putdat);
f0100e6e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0100e71:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0100e75:	c7 04 24 2d 00 00 00 	movl   $0x2d,(%esp)
f0100e7c:	ff 55 08             	call   *0x8(%ebp)
				num = -(long long) num;
f0100e7f:	8b 45 d8             	mov    -0x28(%ebp),%eax
f0100e82:	8b 55 dc             	mov    -0x24(%ebp),%edx
f0100e85:	f7 d8                	neg    %eax
f0100e87:	83 d2 00             	adc    $0x0,%edx
f0100e8a:	f7 da                	neg    %edx
f0100e8c:	b9 0a 00 00 00       	mov    $0xa,%ecx
f0100e91:	eb 77                	jmp    f0100f0a <vprintfmt+0x3ec>
f0100e93:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			base = 10;
			goto number;
...
f0100e96:	89 ca                	mov    %ecx,%edx
f0100e98:	8d 45 14             	lea    0x14(%ebp),%eax
f0100e9b:	e8 24 fc ff ff       	call   f0100ac4 <getuint>
f0100ea0:	b9 0a 00 00 00       	mov    $0xa,%ecx
			base = 10;
			goto number;
f0100ea5:	eb 63                	jmp    f0100f0a <vprintfmt+0x3ec>
f0100ea7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		case 'o':
			...
			// putch('X', putdat);
                        num = getuint(&ap, lflag);
f0100eaa:	89 ca                	mov    %ecx,%edx
f0100eac:	8d 45 14             	lea    0x14(%ebp),%eax
f0100eaf:	e8 10 fc ff ff       	call   f0100ac4 <getuint>
f0100eb4:	b9 08 00 00 00       	mov    $0x8,%ecx
                        base = 8;
                        goto number;
f0100eb9:	eb 4f                	jmp    f0100f0a <vprintfmt+0x3ec>
f0100ebb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
			break;

		// pointer
		case 'p':
			putch('0', putdat);
f0100ebe:	8b 45 0c             	mov    0xc(%ebp),%eax
f0100ec1:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100ec5:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
f0100ecc:	ff 55 08             	call   *0x8(%ebp)
			putch('x', putdat);
f0100ecf:	8b 55 0c             	mov    0xc(%ebp),%edx
f0100ed2:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100ed6:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
f0100edd:	ff 55 08             	call   *0x8(%ebp)
			num = (unsigned long long)
				(uintptr_t) va_arg(ap, void *);
f0100ee0:	8b 45 14             	mov    0x14(%ebp),%eax
f0100ee3:	83 c0 04             	add    $0x4,%eax
f0100ee6:	89 45 14             	mov    %eax,0x14(%ebp)
		...
		case 'p':
			...
			putch('x', putdat);
			num = (unsigned long long)
f0100ee9:	8b 40 fc             	mov    -0x4(%eax),%eax
f0100eec:	ba 00 00 00 00       	mov    $0x0,%edx
f0100ef1:	b9 10 00 00 00       	mov    $0x10,%ecx
				(uintptr_t) va_arg(ap, void *);
			base = 16;
			goto number;
f0100ef6:	eb 12                	jmp    f0100f0a <vprintfmt+0x3ec>
f0100ef8:	89 45 e4             	mov    %eax,-0x1c(%ebp)

		// (unsigned) hexadecimal
		case 'x':
			num = getuint(&ap, lflag);
f0100efb:	89 ca                	mov    %ecx,%edx
f0100efd:	8d 45 14             	lea    0x14(%ebp),%eax
f0100f00:	e8 bf fb ff ff       	call   f0100ac4 <getuint>
f0100f05:	b9 10 00 00 00       	mov    $0x10,%ecx
			base = 16;
		number:
			printnum(putch, putdat, num, base, width, padc);
f0100f0a:	0f be 5d d4          	movsbl -0x2c(%ebp),%ebx
f0100f0e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
f0100f12:	89 74 24 0c          	mov    %esi,0xc(%esp)
f0100f16:	89 4c 24 08          	mov    %ecx,0x8(%esp)
f0100f1a:	89 04 24             	mov    %eax,(%esp)
f0100f1d:	89 54 24 04          	mov    %edx,0x4(%esp)
f0100f21:	8b 55 0c             	mov    0xc(%ebp),%edx
f0100f24:	8b 45 08             	mov    0x8(%ebp),%eax
f0100f27:	e8 a2 fa ff ff       	call   f01009ce <printnum>
f0100f2c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
			break;
f0100f2f:	e9 76 fc ff ff       	jmp    f0100baa <vprintfmt+0x8c>
f0100f34:	8b 55 e4             	mov    -0x1c(%ebp),%edx
f0100f37:	89 45 e4             	mov    %eax,-0x1c(%ebp)

		// escaped '%' character
		case '%':
			putch(ch, putdat);
f0100f3a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
f0100f3d:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f0100f41:	89 14 24             	mov    %edx,(%esp)
f0100f44:	ff 55 08             	call   *0x8(%ebp)
f0100f47:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
			break;
f0100f4a:	e9 5b fc ff ff       	jmp    f0100baa <vprintfmt+0x8c>
			
		// unrecognized escape sequence - just print it literally
		default:
			putch('%', putdat);
f0100f4f:	8b 45 0c             	mov    0xc(%ebp),%eax
f0100f52:	89 44 24 04          	mov    %eax,0x4(%esp)
f0100f56:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
f0100f5d:	ff 55 08             	call   *0x8(%ebp)
			for (fmt--; fmt[-1] != '%'; fmt--)
f0100f60:	8d 43 ff             	lea    -0x1(%ebx),%eax
f0100f63:	80 38 25             	cmpb   $0x25,(%eax)
f0100f66:	0f 84 3e fc ff ff    	je     f0100baa <vprintfmt+0x8c>
f0100f6c:	89 c3                	mov    %eax,%ebx
f0100f6e:	eb f0                	jmp    f0100f60 <vprintfmt+0x442>
				/* do nothing */;
			break;
		}
	}
...
f0100fb9:	c7 04 24 01 0b 10 f0 	movl   $0xf0100b01,(%esp)
f0100fc0:	e8 59 fb ff ff       	call   f0100b1e <vprintfmt>
...
f0101019:	e8 00 fb ff ff       	call   f0100b1e <vprintfmt>
	va_end(ap);
}
f010101e:	c9                   	leave  
f010101f:	c3                   	ret    
...
f0101034:	c7 04 24 fe 1b 10 f0 	movl   $0xf0101bfe,(%esp)
f010103b:	e8 1b f9 ff ff       	call   f010095b <cprintf>

	i = 0;
	echoing = iscons(0);
f0101040:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
f0101047:	e8 4b f3 ff ff       	call   f0100397 <iscons>
f010104c:	89 c7                	mov    %eax,%edi
f010104e:	be 00 00 00 00       	mov    $0x0,%esi
	while (1) {
		c = getchar();
f0101053:	e8 2e f3 ff ff       	call   f0100386 <getchar>
...
f0101062:	c7 04 24 6c 1e 10 f0 	movl   $0xf0101e6c,(%esp)
f0101069:	e8 ed f8 ff ff       	call   f010095b <cprintf>
...
f0101089:	e8 22 f6 ff ff       	call   f01006b0 <cputchar>
			buf[i++] = c;
...
f01012a8:	78 0e                	js     f01012b8 <memset+0x22>
memset(void *v, int c, size_t n)
{
	char *p;
	int m;
...
void *
memset(void *v, int c, size_t n)
f01012ac:	8d 1c 18             	lea    (%eax,%ebx,1),%ebx
	int m;
...
f01012b1:	83 c2 01             	add    $0x1,%edx
	...
	m = n;
	while (--m >= 0)
f01012b4:	39 da                	cmp    %ebx,%edx
f01012b6:	75 f7                	jne    f01012af <memset+0x19>
		*p++ = c;
...
f01012c6:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	d = dst;
	while (n-- > 0)
f01012c9:	85 db                	test   %ebx,%ebx
f01012cb:	74 13                	je     f01012e0 <memcpy+0x25>
f01012cd:	ba 00 00 00 00       	mov    $0x0,%edx
		*d++ = *s++;
f01012d2:	0f b6 0c 16          	movzbl (%esi,%edx,1),%ecx
f01012d6:	88 0c 10             	mov    %cl,(%eax,%edx,1)
f01012d9:	83 c2 01             	add    $0x1,%edx
	const char *s;
	char *d;
	...
	d = dst;
	while (n-- > 0)
f01012dc:	39 da                	cmp    %ebx,%edx
f01012de:	75 f2                	jne    f01012d2 <memcpy+0x17>
		*d++ = *s++;
...
f01012f0:	8b 5d 10             	mov    0x10(%ebp),%ebx
	const char *s;
	char *d;
	
	s = src;
f01012f3:	89 f7                	mov    %esi,%edi
	d = dst;
	if (s < d && s + n > d) {
f01012f5:	39 c6                	cmp    %eax,%esi
f01012f7:	72 0b                	jb     f0101304 <memmove+0x20>
		s += n;
		d += n;
		while (n-- > 0)
f01012f9:	ba 00 00 00 00       	mov    $0x0,%edx
			*--d = *--s;
	} else
		while (n-- > 0)
f01012fe:	85 db                	test   %ebx,%ebx
f0101300:	75 2d                	jne    f010132f <memmove+0x4b>
f0101302:	eb 39                	jmp    f010133d <memmove+0x59>
	const char *s;
	char *d;
	...
	d = dst;
	if (s < d && s + n > d) {
f0101304:	01 df                	add    %ebx,%edi
f0101306:	39 f8                	cmp    %edi,%eax
f0101308:	73 ef                	jae    f01012f9 <memmove+0x15>
		s += n;
		d += n;
		while (n-- > 0)
f010130a:	85 db                	test   %ebx,%ebx
f010130c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
f0101310:	74 2b                	je     f010133d <memmove+0x59>
...
f010132b:	75 ed                	jne    f010131a <memmove+0x36>
f010132d:	eb 0e                	jmp    f010133d <memmove+0x59>
			*--d = *--s;
	} else
		while (n-- > 0)
			*d++ = *s++;
...
f010133b:	75 f2                	jne    f010132f <memmove+0x4b>
			*d++ = *s++;
...
f0101495:	89 13                	mov    %edx,(%ebx)
	return (neg ? -val : val);
f0101497:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
f010149b:	74 04                	je     f01014a1 <strtol+0xe6>
f010149d:	89 c8                	mov    %ecx,%eax
f010149f:	f7 d8                	neg    %eax
}
f01014a1:	83 c4 04             	add    $0x4,%esp
f01014a4:	5b                   	pop    %ebx
f01014a5:	5e                   	pop    %esi
f01014a6:	5f                   	pop    %edi
f01014a7:	5d                   	pop    %ebp
f01014a8:	c3                   	ret    
f01014a9:	00 00                	add    %al,(%eax)
f01014ab:	00 00                	add    %al,(%eax)
f01014ad:	00 00                	add    %al,(%eax)
	...
